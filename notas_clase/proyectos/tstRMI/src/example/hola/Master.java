...
public class Master 
{
    ...
    static void reporta()
    {
        ...
        {
          System.out.println("================================================");  
          System.out.println("    cantidad de clientes:" + Master.servDisparo.cuantosCltes());
          System.out.println("media de tiempo de ciclo:" + Master.servDisparo.deltaTmedia());
          System.out.println(" dev std tiempo de ciclo:" + Master.servDisparo.deltaTStdDev());
          System.out.println("  tiempo de ciclo máximo:" + Master.servDisparo.deltaTMax());
          System.out.println("  tiempo de ciclo mínimo:" + Master.servDisparo.deltTMin());
        }
        catch( Exception e )
        {
            e.printStackTrace();
